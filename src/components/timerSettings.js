    ...
    return (
        <>
            <div id='break' className="d-flex flex-column align-items-center justify-content-center break">
                ...
                <div id='break-length' className="d-flex justify-content-center align-items-center settings-display brightColor">{breakTime}</div>
            ...
            <div id='session' className="d-flex flex-column align-items-center justify-content-center session">
                ...
                <div id='session-length' className="d-flex justify-content-center align-items-center settings-display brightColor">{sessionTime}</div>
